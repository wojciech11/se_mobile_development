...
5. W `build.gradle` (dla **API 30**), w sekcji *dependencies* dodaj wymagaja bibliotkę ktx (roszerzenie, więcej w [dokumentacji](https://developer.android.com/kotlin/ktx/extensions-list)):
